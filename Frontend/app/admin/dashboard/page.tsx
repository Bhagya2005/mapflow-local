  ...
  if (loading) {
    return (
      <div className="h-screen bg-black flex flex-col items-center justify-center text-white">
        ...
        <p className="animate-pulse text-gray-400">Syncing Admin Session...</p>
      </div>
    );
  }
    ...
    <div className="flex h-screen bg-black text-white overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 border-b border-white/10 bg-black/50 flex items-center justify-between px-8">
          <div>
            <h2 className="text-sm font-medium text-gray-400 uppercase tracking-widest">Management</h2>
          ...
          <div className="flex items-center gap-4">
            <div className="text-right hidden sm:block">
              ...
              <p className="text-[10px] text-purple-500 uppercase font-bold">Administrator</p>
            </div>
            <button
              onClick={handleLogout}
              className="ml-4 px-4 py-1.5 bg-purple-600/10 hover:bg-purple-600/20 text-purple-400 border border-purple-600/20 rounded-md text-sm transition-all"
            >
              Sign Out
            </button>
          </div>
