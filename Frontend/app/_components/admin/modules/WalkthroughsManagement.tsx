    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center px-2">
        ...
        <button
          ...
          className="bg-purple-600 hover:bg-purple-500 px-4 py-2 rounded-xl text-white font-bold transition-all shadow-lg shadow-purple-500/20"
        >
          + Add New Step
        </button>
      </div>
          ...
          >
            <div className="divide-y divide-white/5">
              {walkthroughs.length === 0 ? (
                <div className="p-12 text-center text-gray-500">No steps found. Start by adding one!</div>
              ) : (
                walkthroughs.map((w: any) => (
                  <div key={w.id || w._id} className="flex items-center justify-between p-4 hover:bg-white/5 transition-colors">
                    <div className="flex items-center gap-4">
                      <span className="text-gray-600 cursor-grab active:cursor-grabbing">⠿</span>
                      <div>
                    ...
                    <div className="flex gap-3">
                      <button onClick={() => handleOpenModal(w)} className="text-purple-400 hover:text-purple-300 text-sm font-semibold p-2">Edit</button>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-[999] p-4">
          <div className="bg-black border border-white/10 p-6 rounded-3xl w-full max-w-md shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <input
                  className="w-full bg-gray-800 p-3 rounded-xl border border-white/10 text-white outline-none focus:ring-2 focus:ring-purple-500/50"
              ...
              <div className="space-y-1">
                <label className="text-xs text-gray-500 uppercase font-bold ml-1">Points (comma separated)</label>
                <textarea
                  className="w-full bg-gray-800 p-3 rounded-xl border border-white/10 text-white outline-none h-24 focus:ring-2 focus:ring-purple-500/50"
              ...
              <div className="space-y-1">
                <label className="text-xs text-gray-500 uppercase font-bold ml-1">Video URL</label>
                <input
                  className="w-full bg-gray-800 p-3 rounded-xl border border-white/10 text-white outline-none focus:ring-2 focus:ring-purple-500/50"
            ...
            <div className="flex justify-end gap-3 mt-8">
              ...
              <button 
                ...
                className="bg-purple-600 hover:bg-purple-500 px-6 py-2 rounded-xl font-bold text-white disabled:opacity-50 transition-all shadow-lg shadow-purple-600/20"
              >
